...
import 'package:luevano/data/Sample.dart';
import 'package:luevano/helper/Colorsys.dart';
...
class _SingleUserState extends State<SingleUser> {
  ...
  void initState() {
    super.initState();
    currentUser = widget.user ?? Sample.mohammad;
  }
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      makeFollowWidgets(
                          count: currentUser.followers, name: "Followers"),
                      Container(
                        width: 2,
                        height: 15,
                      ...
                      makeFollowWidgets(
                          count: currentUser.following, name: "Following"),
                    ],
                  ),
                  SizedBox(height: 20),
                  makeActionButtons()
            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  makeColloction(currentUser.collocation),
                ],
              ),
            ),
          ],
